...
```bash
-f <(curl -fsL https://www.cloudflare-cn.com/ips-v4) -tn 3000 -dn 10 -sl 15 -tlr 0 -httping https://cp.cloudflare.com/cdn-cgi/trace -url https://speed.cloudflare.com/__down?bytes=524288000
```
